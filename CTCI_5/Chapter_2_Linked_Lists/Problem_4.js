...
module.exports = {
    // O(N * N * log(N)) time
    // O(N) space
    chapterTwoProblemFourBruteForceSolution: (singlyLinkedList, partition) => {
        const list = [];
    ...
    // O(N * N) time;
    // O(N) space;
    chapterTwoProblemFourBookSolutionOne: (singlyLinkedList, partition) => {
    ...
    // O(N) time;
    // O(1) space;
    chapterTwoProblemFourBookSolutionTwo: (singlyLinkedList, partition) => {
