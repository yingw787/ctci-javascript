...
const ArrayOfNumbers_BubbleSort = require('../CTCI_5/Chapter_VII_Technical_Questions/ArrayOfNumbers_BubbleSort');

describe('ArrayOfNumbers_BubbleSort', function() {
    it('should be able to throw error upon initializing with wrong type', function() {
        const array = 5;
        expect(function() {
            new ArrayOfNumbers_BubbleSort(array);
        }).to.throw(Error);
    });
    it('[5, 1, 4, 2, 8] should return [1, 2, 4, 5, 8]', function() {
        const array = [5, 1, 4, 2, 8];
        const sortedArray = new ArrayOfNumbers_BubbleSort(array).sortByAscendingOrder();
