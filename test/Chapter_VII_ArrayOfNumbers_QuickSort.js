...
const ArrayOfNumbers_QuickSort = require('../CTCI_5/Chapter_VII_Technical_Questions/ArrayOfNumbers_QuickSort');

describe('ArrayOfNumbers_QuickSort', function() {
    it('should be able to throw error upon initializing with wrong type', function() {
        const array = 5;
        expect(function() {
            new ArrayOfNumbers_QuickSort(array);
        }).to.throw(Error);
    });
    it('[5, 1, 4, 2, 8] should return [1, 2, 4, 5, 8]', function() {
        const array = [5, 1, 4, 2, 8];
        const sortedArray = new ArrayOfNumbers_QuickSort(array).sortByAscendingOrder();
